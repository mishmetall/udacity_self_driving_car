...
class ParticleFilter {  
 public:
   ...
   */
  void dataAssociation(const Map & map, Particle & p);
  
  /**
   * measurementProbability Finds probability using multivariate gaussian
   * @param p - particle with associations
   * @param map_landmarks
   * @param sigma_landmark - deviation of landmark observations
   * @return
   */
  double measurementProbability(const Particle & p,
